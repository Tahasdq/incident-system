...
const ArrivalAtOccurence = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get("https://incident-system.onrender.com/getnewoccuranceAllStatusWithZero")
      .then((response) => {
    ...
    axios.get(`https://incident-system.onrender.com/getnewoccuranceocurrencesgarissonwithtruedisabled/${arriveId}`)
      .then((response) => {
  ...
  const handleInput = (e) => {
    ...
    axios
      .get(`https://incident-system.onrender.com/getnewoccuranceAllStatus/${id}`)
      .then((response) => {
  ...
  const handleStatus = (e) => {
    e.preventDefault();
    axios.put(`https://incident-system.onrender.com/occuranceDispatcharrivegarrison/${arriveId}`, { garissonIds })
      .then((response) => {
        // Update Occurance_hold after the arrival status has been successfully updated
        setjugaar(response)
        setFindGarission([])
        axios.get("https://incident-system.onrender.com/getnewoccuranceAllStatusWithZero")
          .then((response) => {
            setOccurance_hold(response.data);
          })
          .catch((error) => {
    ...
    if (alltruegarrisionallgarison === allgarisonLength) {
      ...
      axios.put(`https://incident-system.onrender.com/occuranceDispatcharrive/${arriveId}`, { InformedOfArrivalBy })
        .then((response) => {
      ...
      axios.put(`https://incident-system.onrender.com/getnewoccuranceAllStatusWithZero/${arriveId}`)
        .then((response) => {
          console.log("data is ", response);
          axios
            .get("https://incident-system.onrender.com/getnewoccuranceAllStatusWithZero")
