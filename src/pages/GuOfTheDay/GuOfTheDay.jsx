...
const GuOfTheDay = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get("https://incident-system.onrender.com/getnewoccuranceAllStatus")
      .then((response) => {
  ...
  const handleData = (e) => {
    ...
    axios.put(`https://incident-system.onrender.com/occuranceDispatch/${occuranceId}`, { DispatchBy })
      .then((response) => {
        console.log("data is ", response);
        axios.get("https://incident-system.onrender.com/getnewoccuranceAllStatus")
          .then((response) => {
            SetOccurance_hold(response.data);
          })
          .catch((error) => {
    ...
    // dispatch time added 
    axios.put(`https://incident-system.onrender.com/occuranceDispatchTime/${occuranceId}`)
      .then((response) => {
    ...
    axios.put(`https://incident-system.onrender.com/updataGarrison`, { dataArray: bunchId })
      .then((response) => {
        console.log(response);
        // Fetch updated GarisonFalse data after dispatch
        axios.get("https://incident-system.onrender.com/getGarrison")
          .then((response) => {
            setGarisonFalse(response.data);
    ...
    axios.put(`https://incident-system.onrender.com/occuranceDispatchGarison/${occuranceId}`, { dataArray: av_garison })
      .then((response) => {
        console.log(response);
      })
      .catch((error) => {
