...
const ServiceNew = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://incident-system.onrender.com/getoccurance")
      .then((response) => {
    ...
    axios
      .get("https://incident-system.onrender.com/getnewoccurance")
      .then((response) => {
        // Set the fetched data in state
    ...
    axios
      .get("https://incident-system.onrender.com/getGarrison")
      .then((response) => {
    ...
    axios
      .get("https://incident-system.onrender.com/getGarrisonFalse")
      .then((response) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const responsePost = await axios.post("https://incident-system.onrender.com/newOccurance", { ...post, MadeBy });
      console.log(responsePost);

      // Call the API to delete old occurrences with status 0 or 2
      await axios.delete("https://incident-system.onrender.com/deleteOldOccurrences", { data: post });


      if (StaffIds.length !== 0) {
        console.log("Callled");
        const updateStaffResponse = await axios.put('https://incident-system.onrender.com/updateGarrisoninServiceNew', { dataArray: StaffIds });
      ...
      // const responsePut = await axios.put(`https://incident-system.onrender.com/updataGarrison/${GarrisonId}`);
      // console.log(responsePut);

      const responseGetGarrison = await axios.get("https://incident-system.onrender.com/getGarrison");
      setNewGarrison(responseGetGarrison.data);
      console.log("Garrison", responseGetGarrison.data);

      const responseGetGarrisonFalse = await axios.get("https://incident-system.onrender.com/getGarrisonFalse");
