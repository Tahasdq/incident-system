...
const ViewItems = () => {
  ...
  useEffect(() => {
    axios.get("https://incident-system.onrender.com/admin/dashboard/viewitems/getRegisteredUser")
      .then((res) => {
  ...
  const handleSave = () => {
    axios.put(`https://incident-system.onrender.com/updateOccurence/${selectedUser._id}`, { username, password, designation })
      .then((res) => {
        console.log(res);
  ...
  const handleConfirmDelete = () => {
    ...
    axios.delete(`https://incident-system.onrender.com/deleteoccurrence/${selectedUser._id}`)
      .then((res) => {
