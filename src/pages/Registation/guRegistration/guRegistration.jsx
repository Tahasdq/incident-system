...
const GuRegistration = () => {
  ...
  useEffect(() => {
    axios.get('https://incident-system.onrender.com/getStaffStatus')
      .then((response) => {
    ...
    axios.get('https://incident-system.onrender.com/getVehcleStatus')
      .then((response) => {
  ...
  const handleDelete = (e) => {
    ...
    if (garison.length > 0) {
      ...
      axios.delete('https://incident-system.onrender.com/deleteGarrisonStatus')
        .then((response) => {
      ...
      axios.put('https://incident-system.onrender.com/statustrueStaff')
        .then((response) => {
      ...
      axios.put('https://incident-system.onrender.com/statustrueVehcle')
        .then((response) => {
          // console.log(dispatch, response.data)
        })
        .catch((error) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await axios.post('https://incident-system.onrender.com/newGarisson', postData);
      ...
      const updateVehicleResponse = await axios.put(`https://incident-system.onrender.com/updateVehicle/${vechicleId}`);
      console.log(updateVehicleResponse);
      console.log("update vehicle api working");

      const updateStaffResponse = await axios.put('https://incident-system.onrender.com/updateStaff', { dataArray: staffIds });
      console.log(updateStaffResponse);
      console.log("update staff api working");

      // Fetch updated garisson data
      // const garissonResponse = await axios.get('https://incident-system.onrender.com/newGarissonData');
      // setGarison(garissonResponse.data);
      // console.log("New garission data api working");

      // Fetch updated vehicle and staff status
      const vehicleResponse = await axios.get('https://incident-system.onrender.com/getVehcleStatus');
      setVehicle(vehicleResponse.data);
      console.log("getVehicle stats api working");

      const staffResponse = await axios.get('https://incident-system.onrender.com/getStaffStatus');
      setStaff(staffResponse.data);
      console.log("getstaff stats api working");

      // Fetch updated garisson data again
      const updatedGarissonResponse = await axios.get('https://incident-system.onrender.com/newGarissonData');
