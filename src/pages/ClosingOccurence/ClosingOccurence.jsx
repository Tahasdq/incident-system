...
const ClosingOccurence = () => {
  ...
  const handleFieldChange = (id, key, value) => {
    ...
    if (key === "phone") {
      ...
      axios.get(`https://incident-system.onrender.com/getoccurencebyphonenumber/${value}`)
        .then((res) => {
  ...
  useEffect(() => {
    axios.get("https://incident-system.onrender.com/getSaveOccurence")
      .then((res) => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get("https://incident-system.onrender.com/getnewoccuranceAllStatusWithZeroAndTwo")
      .then((response) => {
    ...
    axios
      .get("https://incident-system.onrender.com/getGarrisonAll")
      .then((response) => {
    ...
    axios.get('https://incident-system.onrender.com/newGarissonData')
      .then((response) => {
    ...
    axios.get("https://incident-system.onrender.com/getApplicants").then((response) => {
      setApplicants(response.data);
      console.log(response.data);
    });

    axios.get("https://incident-system.onrender.com/getStreet").then((response) => {
  ...
  const handleDeleteClick = (e) => {
    ...
    axios.post("https://incident-system.onrender.com/createreport", { IdOfOccurence, formFields, description })
      .then((response) => {
    ...
    axios
      .put(`https://incident-system.onrender.com/updataGarrisonToTrue/${id}`)
      .then((response) => {
        console.log(response);
      })
      .catch((error) => {
    ...
    axios.put(`https://incident-system.onrender.com/occuranceclosed/${id}`, { ClosedBy })
      .then((response) => {
    ...
    axios
      .put(`https://incident-system.onrender.com/updataGarrisonStat`, {})
      .then((response) => {
        console.log(response);
      })
      .catch((error) => {
  ...
  const handleCloseAndDelete = () => {
    axios.delete(`https://incident-system.onrender.com/saveOccurenceDelete/${idForSaving}`)
      .then((res) => {
  ...
  const showReport = (id) => {
    ...
    axios.get(`https://incident-system.onrender.com/view-pdf/new/${id}?ReportCreatedBy=${ReportCreatedBy}`, { responseType: 'text' })
      .then((response) => {
  ...
  const handleClose = (event, reason) => {
    ...
    if (reason !== 'backdropClick' && reason !== 'escapeKeyDown') {
      ...
      axios.put(`https://incident-system.onrender.com/saveOccurence/${idForSaving}`, { formFields, description })
        .then((res) => {
          console.log(res)
          setOpen(false);
          // setSelectedValue(""); // Reset selectedValue on dialog close
  ...
  const onActive = (id) => {
    ...
    axios.put(`https://incident-system.onrender.com/newGarisonActive/${id}`).then((response) => console.log(response))

    axios.get('https://incident-system.onrender.com/newGarissonData').then((response) => {
      setGarison(response.data);
    })
  ...
  const onInActive = (id) => {
    ...
    axios.put(`https://incident-system.onrender.com/newGarisonInActive/${id}`).then((response) => console.log(response))
    axios.get('https://incident-system.onrender.com/newGarissonData').then((response) => {
      setGarison(response.data);
    })
